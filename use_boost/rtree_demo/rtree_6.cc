// https://live.boost.org/doc/libs/1_85_0/libs/geometry/doc/html/geometry/spatial_indexes/rtree_examples/range_adaptors.html
...
// Define a function object converting a value_type of indexed Range into
// std::pair<>. This is a generic implementation but of course it'd be possible
// to use some specific types. One could also take Value as template parameter
// and access first_type and second_type members, etc.
